 ...
 *
 */
public class Swalile extends Pokemon {
	...
	private static final String NAME = "SWALILE";
	 ...
	 * @param shiny
	 */
	public Swalile(int gender, int level, boolean shiny) {
	 ...
	 * @param shiny
	 */
	public Swalile(int level, int maxHP, int gender, Nature personality,
