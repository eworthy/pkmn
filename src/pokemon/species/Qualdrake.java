 ...
 *
 */
public class Qualdrake extends Pokemon {
	...
	private static final int POKEDEX = 11;
	 ...
	 * @param shiny
	 */
	public Qualdrake(int gender, int level, boolean shiny) {
	 ...
	 * @param shiny
	 */
	public Qualdrake(int level, int maxHP, int gender, Nature personality,
