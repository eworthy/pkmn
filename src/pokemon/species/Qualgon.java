 ...
 *
 */
public class Qualgon extends Pokemon {
	...
	private static final String NAME = "QUALGON";
	private static final PkmnType[] TYPES = {PkmnType.GRASS,
											 PkmnType.DRAGON}; //grass + dragon
	private static final Class<? extends Pokemon> BOTTOM_EVOLUTION = Qualbud.class;
	private static final Class<? extends Pokemon> NEXT_EVOLUTION = Qualdrake.class;
	private static final int POKEDEX = 10;
	 ...
	 * @param shiny
	 */
	public Qualgon(int gender, int level, boolean shiny) {
	 ...
	 * @param shiny
	 */
	public Qualgon(int level, int maxHP, int gender, Nature personality,
