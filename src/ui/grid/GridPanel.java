...
public class GridPanel extends JPanel implements Scrollable
{
     ...
     * empty.
     */
    public GridPanel(ResourceBundle res)
    {
        resources = res;
...
//        drawGridlines(g2);
    ...
    private void drawOccupant(Graphics2D g2, int xleft, int ytop, Object obj)
    {
        ...
        if (cellToDraw.intersects(g2.getClip().getBounds()))
        {
            ...
            //obj to draw goes here
            Actor a = (Actor) obj;
            //a.draw(g2copy); //my object must have a draw method, 'obj' in this line is replaced w its name (might not need?)
            g2copy.dispose();
        }
    }
